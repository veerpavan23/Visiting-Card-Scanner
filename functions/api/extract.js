/**
 * Vertex AI Proxy - Enterprise Card Extraction
 * Region: us-east1 (Optimized for Low Latency)
 * Mode: Service Account OAuth 2.0
 */

// Service Account Config (Transferred from Enterprise Scan Project)
const SVC_ACC = {
...
/**
 * Native JWT Signer for Cloudflare Worker environment (Web Crypto API)
 */
async function getAccessToken() {
    ...
    // PEM to ArrayBuffer (Cleanup PEM junk)
